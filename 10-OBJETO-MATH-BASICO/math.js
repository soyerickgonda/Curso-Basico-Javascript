...
//desarrollar : calcular promedio solo de los salarios mayores a 0
//si todos los salarios son = 0, retornar 0 comor rspta

// function calcularPromedioSalarios(salarios) {
//     let promedio = 0;
//     const sumaSalario = salarios.reduce((acumulador, monto)=>{return acumulador + monto},0)
//     return sumaSalario;
// }
// const salarios = [0,2000,1500,0,1600,8000,0];
// console.log(calcularPromedioSalarios(salarios));
